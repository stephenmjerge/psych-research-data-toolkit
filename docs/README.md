...
Welcome! These short guides explain how to run the Psych Research Data Toolkit (PRDT) even if you are not a developer. Start with the Walkthrough to see the full pipeline, then refer to Concepts and Quickstart when you need refreshers.
